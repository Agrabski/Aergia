...
namespace antlr4 {
  ...
  protected:
    ...
    /// </summary>
  public:
    void reset(Parser *recognizer) noexcept override;
  ...
  protected:
    virtual void beginErrorCondition(Parser *recognizer) noexcept;

    /// <summary>
    /// {@inheritDoc}
    /// </summary>
  public:
    bool inErrorRecoveryMode(Parser *recognizer) noexcept override;
  ...
  protected:
    void endErrorCondition(Parser *recognizer) noexcept;
    ...
    /// </summary>
  public:
    void reportMatch(Parser *recognizer)  noexcept override;
