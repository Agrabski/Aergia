...
namespace antlr4 {
	namespace atn {
		...
		public:
			...
			virtual void copyState( LexerATNSimulator* simulator ) noexcept;
			virtual size_t match( gsl::not_null<CharStream*>input, size_t mode );
		...
		protected:
			...
			///  parameter.
			/// </summary>
			void getReachableConfigSet( gsl::not_null< CharStream*> input,gsl::not_null< ATNConfigSet*> closure_, // closure_ as we have a closure() already
				gsl::not_null<ATNConfigSet*> reach, size_t t );
			...
			virtual ATNState* getReachableTarget( gsl::not_null<Transition*> trans, size_t t );
			...
			virtual void captureSimState( CharStream* input, dfa::DFAState* dfaState ) noexcept;
		...
		public:
			...
			virtual size_t getCharPositionInLine() noexcept;
			virtual void setCharPositionInLine( size_t charPositionInLine ) noexcept;
