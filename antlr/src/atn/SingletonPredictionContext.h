...
namespace atn {
  ...
  public:
    ...
    Ref<PredictionContext> getParent(size_t index) const noexcept override;
    size_t getReturnState(size_t index) const noexcept override;
    bool operator == (const PredictionContext &o) const noexcept override;
