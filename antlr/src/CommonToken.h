...
namespace antlr4 {
  ...
  public:
    ...
    virtual size_t getType() const noexcept override;
    ...
    void setLine(size_t line) noexcept override;
    size_t getLine() const noexcept override;

    size_t getCharPositionInLine() const noexcept override;
    void setCharPositionInLine(size_t charPositionInLine) noexcept override;

    size_t getChannel() const noexcept override;
    void setChannel(size_t channel) noexcept override;

    void setType(size_t type) noexcept override;

    size_t getStartIndex() const noexcept override;
    void setStartIndex(size_t start) noexcept;

    size_t getStopIndex() const noexcept override;
    void setStopIndex(size_t stop) noexcept;

    size_t getTokenIndex() const noexcept override;
    void setTokenIndex(size_t index) noexcept override;
